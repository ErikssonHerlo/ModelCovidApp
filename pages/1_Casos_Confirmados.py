...
st.title("Casos Confirmados por Laboratorio")
st.write("""
Se le llama así a un caso con cualquier resultado de prueba antígeno o PCR para la detección de SARS-CoV2 positivo registrado en el sistema de información del MSPAS.
""")
st.write("Donde: ")
...
st.write("- **Casos por Fecha de Toma de Muestra:** representa el número total de hisopados realizados ese día por un laboratorio.")
...
if(uploadFile is not None):
    ...
    if st.button('Calcular'):
        ...
        st.metric(f"El valor de la predicción de Casos para {daysToPredict} dias desde el inicio de la pandemia es de: ",valuePredict, indicadorPrediccion)
